...
const selectors = {
  ...
  cardExtraInfo: '.product-card-hover-info'
};
...
export default class ProductCard {
  ...
  constructor(el) {
    ...
    this.$el.on('mouseenter', this.onShowButtons.bind(this));
    this.$el.on('mouseleave', this.onHideButtons.bind(this));
  }
  ...
  // usign .stop() to prevent the event from firing too much
  onShowButtons(e) {
    e.preventDefault();
    $('.product-card-hover-info', this.$el).stop().slideDown();
  }

  onHideButtons(e) {
    e.preventDefault();
    $('.product-card-hover-info', this.$el).stop().slideUp();
  }
