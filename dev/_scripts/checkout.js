...
// adding a order message on the checkout for the care team.
const ordermessage = document.createElement('div');
ordermessage.innerHTML += `
<p id="orderWarning">Orders cannot be cancelled or modified after they are placed.</p>
<p>By submitting this order, you agree to the terms of our <a href="https://4moms.zendesk.com/hc/en-us/articles/360040518252-Shipping-and-Returns#returns">Return Policy.</a></p>
`;
document.querySelector('.main__content').appendChild(ordermessage);


// document.querySelectorAll('.product__quantity .visually-hidden').removeClass('visually-hidden');
